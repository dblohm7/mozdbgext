...
LIB="${DBGLIB};${LIB}"
RELEASE_OPTS="-O2 -Oy-"
cl -Zi -EHsc -LD -MT -DUNICODE -D_UNICODE ${RELEASE_OPTS} mozdbgext.cpp mozdbgextcb.cpp mozmutex.cpp knownstruct.cpp uiext.cpp bpsyms.cpp dbgeng.lib pathcch.lib user32.lib -link -def:mozdbgext.def
