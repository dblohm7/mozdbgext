...
LIB="${DBGLIB};${LIB}"
cl -Zi -EHsc -LD -MD -DUNICODE -D_UNICODE -DDEBUG mozdbgext.cpp mozdbgextcb.cpp mozmutex.cpp knownstruct.cpp bpsyms.cpp dbgeng.lib pathcch.lib -link -def:mozdbgext.def
