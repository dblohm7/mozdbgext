...
LIB="${DBGLIB};${LIB}"
cl -Zi -EHsc -LD -MD -DUNICODE -D_UNICODE mozdbgext.cpp mozdbgextcb.cpp mozmutex.cpp knownstruct.cpp uiext.cpp bpsyms.cpp dbgeng.lib pathcch.lib user32.lib -link -def:mozdbgext.def
